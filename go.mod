...
replace (
	...
	github.com/moby/term => github.com/moby/term v0.0.0-20200611042045-63b9a826fb74
	...
	github.com/shirou/gopsutil => github.com/shirou/gopsutil v2.20.6+incompatible
